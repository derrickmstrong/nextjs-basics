...
<!-- [![Product Name Screen Shot][product-screenshot]](https://example.com) -->
 ...
 <!-- `derrickmstrong`, `nextjs-basics`, `dmstr0ng`, `derrickmstrong`, `gmail`, `derrickmstrong`, `nextjs-basics`, `This is a basic Next.js app created to understand and reinforce some fundamental concepts` -->
...
See the [open issues](https://github.com/derrickmstrong/nextjs-basics/issues) for a full list of proposed features (and known issues).
